...
$loginresult=mysqli_query($loginquery);
...
$userinforesult=mysqli_query($userinfoquery);
...
if (isset($userinfo['defaultpicid']))
{
	...
	$result=mysqli_query($picinfoquery,$conc) or die("Unable to insert pictureinfo into db");
	
	$picinfo = mysqli_fetch_assoc($result);
	$ext = $picinfo['ext'];
	$width = $picinfo['width'];
