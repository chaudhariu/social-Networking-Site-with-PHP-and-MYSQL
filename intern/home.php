...
<html>
	...
	<head>
		<title>Welcome  To Robin's Nest - Sign up, Log in, Post </title>
...
<?php include ('session.php');?>
	...
	<div id="header">
		<div class="head-view">
			<ul>
				<li><a href="home.php" title="Robin's Nest"><b>Robin's Nest</b></a></li>
				<li></li>
				<li></li>
				<li></li>
				<li></li>
				...
				<li><a href="Messages.php" title="Settings"><label>Messages</label></a></li>
			</ul>
		</div>
	</div>
